...
function Profile() {
  ...
  const saveProfile = async () => {
    ...
    try {
      ...
      alert(error.response?.data?.message || error.message || "Erro ao salvar perfil. Tente novamente.");
    }
  };
        ...
        <div className="h-[600px] w-[90%] bg-white rounded-lg shadow-md p-7 mx-auto mt-20">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className={`px-4 py-2 rounded transition ${editMode ? "bg-green-500 font-bold hover:scale-105 duration-300 hover:bg-green-600 text-white" : "bg-blue-500 font-bold hover:bg-blue-600 text-white hover:scale-105 duration-300"}`}
            >
